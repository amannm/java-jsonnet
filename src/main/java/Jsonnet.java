...
public class Jsonnet implements Closeable {
    ...
    private final MemorySegment instancePointer;
    private final MemorySegment blankPointer;
    ...
    public Jsonnet(String libraryName) throws Throwable {
        ...
        this.instancePointer = (MemorySegment) method.invokeExact();
        this.blankPointer = arena.allocateUtf8String("");
    }
    ...
    public String evaluate(String snippet) throws Throwable {
        ...
        var methodHandle = linker.downcallHandle(methodAddress, methodSignature);
        var snippetPointer = arena.allocateUtf8String(snippet);
        var errorCodePointer = arena.allocate(ValueLayout.JAVA_LONG);
        var result = (MemorySegment) methodHandle.invokeExact(instancePointer, blankPointer, snippetPointer, errorCodePointer);
    ...
    public void release(MemorySegment snippet) throws Throwable {
        ...
        methodHandle.invoke(instancePointer, snippet, 0L);
    }
    ...
    public void close() {
        try {
            ...
            call.invokeExact(instancePointer);
        } catch (Throwable e) {
